    ...
    return (
        <div class="h-96 md:h-screen flex flex-col justify-center items-center bg-black text-center relative">
            ...
            <div class="max-w-full md:max-w-5xl px-6">
                <h1 class="text-lg md:text-4xl font-bold mb-4 text-white text-left leading-9 font-light ">Bienvenido a la comunidad digital definitiva que te conecta con lo que necesitas para seguir creciendo , avanzando y expandíendote por el mundo digital.</h1>
                <p class="text-lg md:text-2xl text-lightgray text-left pt-1">No olvides quitarte los zapatos antes de entrar</p>
            </div>
