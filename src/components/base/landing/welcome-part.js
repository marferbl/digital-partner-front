    ...
    return (
        <div class="h-96 md:h-screen flex flex-col justify-center items-center bg-black text-center relative">
            ...
            <div class="max-w-full md:max-w-5xl px-6">
                <h1 class="text-lg md:text-4xl font-semibold mb-4 text-white text-left leading-9 ">{t('welcomeFirst')}</h1>
                <p class="text-lg md:text-2xl text-lightgray font-light text-left pt-1">{t('welcomeSecond')}</p>
            </div>
